...
sMynameis <- "ShelfAnalyze-glitchimpact-08.r"
...
{
    colnames(summ) <- c("docsize","lifem","glitchimpact","c1","c2","c3","c4","c5","c8")
...
colnames(summid) <- c("docsize","lifem","glitchimpact","c1","c2","c3","c4","c5","c8")
#datn = data.frame(dat$docsize,dat$lifem,dat$glitchimpact,dat$copies,dat$lost)
...
colnames(sumt) <- c("docsize","lifem","glitchimpact","c1","c2","c3","c4","c5","c8")
#datn = data.frame(dat$docsize,dat$lifem,dat$glitchimpact,dat$copies,dat$lost)
